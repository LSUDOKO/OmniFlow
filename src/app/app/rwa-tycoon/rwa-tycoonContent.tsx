...
export default function RWATycoonContent() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <GlassCard className="p-8 bg-gradient-to-r from-gold-500/20 to-gold-600/20 border-gold-500/30">
      ...
      <motion.div
        ...
        className="flex space-x-1 bg-white/5 rounded-xl p-1"
      >
        {[
        ...
        {selectedTab === 'achievements' && (
          ...
          >
            {achievements.map((achievement) => (
              <GlassCard key={achievement.id} className={`p-6 ${!achievement.unlocked ? 'opacity-60' : ''}`}>
              ...
              <div className="grid grid-cols-7 gap-4 mb-8">
                {dailyRewards.map((reward) => (
                  <div key={reward.day} className={cn(
                    "bg-white/5 rounded-2xl p-4 text-center transition-all duration-300",
